...
public final class Factory extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("4015bfc4b265c0711fe65640b70227f3f5f66b226ff1d2fd22a803434bc6227c", "Daml.Finance.Holding.NonTransferable", "Factory");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Factory> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "com.daml.quickstart.model.daml.finance.holding.nontransferable.Factory", TEMPLATE_ID,
  ...
  public String toString() {
    return String.format("com.daml.quickstart.model.daml.finance.holding.nontransferable.Factory(%s, %s)",
