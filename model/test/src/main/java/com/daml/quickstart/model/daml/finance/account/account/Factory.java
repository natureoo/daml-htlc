...
public final class Factory extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("99a5a2f08e458a0b90713f4d723fccdcc55474824126bea47a635460ec6eb688", "Daml.Finance.Account.Account", "Factory");
  ...
  public static final ContractCompanion.WithoutKey<Contract, ContractId, Factory> COMPANION = 
      new ContractCompanion.WithoutKey<>(
        "com.daml.quickstart.model.daml.finance.account.account.Factory", TEMPLATE_ID,
  ...
  public String toString() {
    return String.format("com.daml.quickstart.model.daml.finance.account.account.Factory(%s, %s)",
  ...
  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Factory> implements Exercises<ExerciseCommand> {
    ...
    public com.daml.quickstart.model.daml.finance.interface$.account.factory.Factory.ContractId toInterface(
        com.daml.quickstart.model.daml.finance.interface$.account.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new com.daml.quickstart.model.daml.finance.interface$.account.factory.Factory.ContractId(this.contractId);
    }
    ...
    public static ContractId unsafeFromInterface(
        com.daml.quickstart.model.daml.finance.interface$.account.factory.Factory.ContractId interfaceContractId) {
  ...
  public static final class CreateAnd extends com.daml.ledger.javaapi.data.codegen.CreateAnd implements Exercises<CreateAndExerciseCommand> {
    ...
    public com.daml.quickstart.model.daml.finance.interface$.account.factory.Factory.CreateAnd toInterface(
        com.daml.quickstart.model.daml.finance.interface$.account.factory.Factory.INTERFACE_ interfaceCompanion) {
      return new com.daml.quickstart.model.daml.finance.interface$.account.factory.Factory.CreateAnd(COMPANION, this.createArguments);
    }
